...
This page outlines the plan and key points for Session 0 of the Algorath campaign.
...
- Private messages may be sent for character-specific knowledge based on background or interactions.
...
- Question for the group: What do we plan on doing for food for the sessions? (Long sessions are usually better with food.)

## Next Steps
- Character creation discussion.
- Q&A on rules and expectations.

[[Home]] | [[Grok-Context-Summary]]
