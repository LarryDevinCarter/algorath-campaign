...
**High Command**
- **High Marshall**  
  Elected leader of the entire Gray Company.
...
- **First Pathfinder**
- **First Steward**  
  (Leaders of their respective orders and advisory council to the High Marshall.)

**Elite Tier**
- **Warden**  
  Limited number (roughly 3–4 per order). The trusted inner circle, proven leaders, and most likely successors to a First. They command major operations, waystations, and can grant special dispensations.

**Experienced / Full Rights Tier**
- **Fellow (or Fellow of the Gray)**  
  Members who have proven themselves reliable after serving as a basic Member. They have full rights and greater autonomy.
  - For Hunters, only Fellows (and higher) can normally receive contracts independently.
  - They lead smaller teams, handle important duties with less supervision, and are trusted to operate more independently across the High Piedmont and beyond.

**Core Membership**
- **Member**  
  The standard rank for those who have completed training and sworn the full oaths. Full members of the Gray Company with basic rights and responsibilities. They form the backbone of daily operations but work under more oversight than Fellows.

**Entry Level**
- **Recruit**  
  New trainees who have not yet taken the binding oaths. They assist, learn, and must pass order-specific trials before advancing to Member.

**Quick Summary of Progression**  
Recruit → Member (sworn basic member) → Fellow (proven, full rights, reliable autonomy) → Warden (elite few) → First → High Marshall
...
Founded nearly 300 years ago in the aftermath of generations of devastating border wars that left the wilds lawless. The Gray Company emerged from scattered bands of hunters and rangers who banded together under a simple gray banner.
